...
model = pickle.load(open('osip', 'rb'))
#model = pickle.load(open('online_shoppers_intention.csv','rb'))
...
def features():
    ...
    if (request.method=='POST'):
        ...
        if output:
            color = "text-success"
            messege = "Model predicts, the Customer will Purchase and revenue is generated!"
        else:
            color = "text-danger"
            messege = "Model predicts, the customer will not purchase and revenue will not be generated"
